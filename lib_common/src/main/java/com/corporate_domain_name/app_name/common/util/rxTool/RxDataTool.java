package com.corporate_domain_name.app_name.common.util.rxTool;
...
import static com.corporate_domain_name.app_name.common.util.rxTool.RxConstTool.BYTE;
import static com.corporate_domain_name.app_name.common.util.rxTool.RxConstTool.GB;
import static com.corporate_domain_name.app_name.common.util.rxTool.RxConstTool.KB;
import static com.corporate_domain_name.app_name.common.util.rxTool.RxConstTool.MB;
...
public class RxDataTool {
     ...
     * @return
     */
    public static boolean isNullString2(@Nullable String str) {
        return str == null || str.length() == 0 || "null".equals(str)
                || str.equals(TBApplicationProxy.getInstanceApplication().getString(R.string.str_));
    }
     ...
     * @return
     */
    public static float getRoundUpf(double value, int digit) {
        BigDecimal result = new BigDecimal(value);
        return result.setScale(digit, BigDecimal.ROUND_HALF_UP).floatValue();
    }
