package com.corporate_domain_name.app_name.common.widget;
...
public class RxToast {
    ...
    public static void normal(@NonNull String message) {
        normal(TBApplicationProxy.getInstanceApplication(), message, Toast.LENGTH_SHORT, null, false).show();
    }

    public static void normal(@NonNull String message, Drawable icon) {
        normal(TBApplicationProxy.getInstanceApplication(), message, Toast.LENGTH_SHORT, icon, true).show();
    }

    public static void normal(@NonNull String message, int duration) {
        normal(TBApplicationProxy.getInstanceApplication(), message, duration, null, false).show();
    }

    public static void normal(@NonNull String message, int duration, Drawable icon) {
        normal(TBApplicationProxy.getInstanceApplication(), message, duration, icon, true).show();
    }

    public static Toast normal(@NonNull String message, int duration, Drawable icon, boolean withIcon) {
        return custom(TBApplicationProxy.getInstanceApplication(), message, icon, DEFAULT_TEXT_COLOR, duration, withIcon);
    }

    public static void warning(@NonNull String message) {
        warning(TBApplicationProxy.getInstanceApplication(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void warning(@NonNull String message, int duration) {
        warning(TBApplicationProxy.getInstanceApplication(), message, duration, true).show();
    }

    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(TBApplicationProxy.getInstanceApplication(), message, getDrawable(TBApplicationProxy.getInstanceApplication(), R.drawable.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }

    public static void info(@NonNull String message) {
        info(TBApplicationProxy.getInstanceApplication(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void info(@NonNull String message, int duration) {
        info(TBApplicationProxy.getInstanceApplication(), message, duration, true).show();
    }

    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(TBApplicationProxy.getInstanceApplication(), message, getDrawable(TBApplicationProxy.getInstanceApplication(), R.drawable.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }

    public static void success(@NonNull String message) {
        success(TBApplicationProxy.getInstanceApplication(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void success(@NonNull String message, int duration) {
        success(TBApplicationProxy.getInstanceApplication(), message, duration, true).show();
    }

    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(TBApplicationProxy.getInstanceApplication(), message, getDrawable(TBApplicationProxy.getInstanceApplication(), R.drawable.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }

    public static void error(@NonNull String message) {
        error(TBApplicationProxy.getInstanceApplication(), message, Toast.LENGTH_SHORT, true).show();
    }
    ...
    public static void error(@NonNull String message, int duration) {
        error(TBApplicationProxy.getInstanceApplication(), message, duration, true).show();
    }

    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(TBApplicationProxy.getInstanceApplication(), message, getDrawable(TBApplicationProxy.getInstanceApplication(), R.drawable.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull String message, Drawable icon, @ColorInt int textColor, @ColorInt int tintColor, int duration, boolean withIcon, boolean shouldTint) {
        ...
        final View toastLayout = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.common_toast_layout, null);
    ...
    public static void showToastShort(String str) {
        Toast.makeText(TBApplicationProxy.getInstanceApplication(), str, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastShort(int resId) {
        Toast.makeText(TBApplicationProxy.getInstanceApplication(), TBApplicationProxy.getInstanceApplication().getApplicationContext().getString(resId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastLong(String str) {
        Toast.makeText(TBApplicationProxy.getInstanceApplication(), str, Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToastLong(int resId) {
        Toast.makeText(TBApplicationProxy.getInstanceApplication(), TBApplicationProxy.getInstanceApplication().getString(resId), Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToast(String msg) {
        if (mToast == null) {
            mToast = Toast.makeText(TBApplicationProxy.getInstanceApplication(), msg, Toast.LENGTH_LONG);
        } else {
            mToast.setText(msg);
        }
        mToast.show();
    ...
    public static void showToast(int resId) {
        if (mToast == null) {
            mToast = Toast.makeText(TBApplicationProxy.getInstanceApplication(), TBApplicationProxy.getInstanceApplication().getString(resId), Toast.LENGTH_LONG);
        } else {
            mToast.setText(TBApplicationProxy.getInstanceApplication().getString(resId));
        }
        mToast.show();
    }
