...
public final class AdaptScreenUtils {
        ...
        if (!isInitMiui) {
            ...
            if ("MiuiResources".equals(simpleName) || "XResources".equals(simpleName)) {
                try {
                    ...
                    LogUtil.e("AdaptScreenUtils", "no field of mTmpMetrics in resources.");
                }
            }
            isInitMiui = true;
            return ret;
    ...
    public static int replyPtValue(Resources resources, float value) {
        float value2 = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PT, value, resources.getDisplayMetrics());
        closeAdapt(resources);
        return AdaptScreenUtils.pt2Px(value2);
//        return  SystemUtil.px2dp(value);
//        AdaptScreenUtils.closeAdapt(resources);
//        return AdaptScreenUtils.px2Pt(value);
    }
}